// Adapted currency line-chart example from https://github.com/esnet/react-timeseries-charts/tree/master/src/website/packages/charts/examples/currencys
...
import { Baseline, LineChart, Legend, Resizable, ChartContainer, ChartRow, Charts, YAxis, styler } from "react-timeseries-charts";


// Data
const aud = require("./default-data/usd_vs_aud.json");
const euro = require("./default-data/usd_vs_euro.json");
